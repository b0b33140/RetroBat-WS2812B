//Based on NeoPixel LED Digital Strip Cylon Eye v1.10 Created by EternalCore
// Adapted with snowfall effect by MiketheChap. All kudos go to EternalCore
#include <Adafruit_NeoPixel.h>

//Settings:
#define PIN 3 //The Pin out your Neopixel DIN strip/stick is connected to (Default is 6)
#define TPIXEL 50 //The total amount of pixel's/led's in your connected strip/stick (Default is 60)
...
int wait_T=200; //This is the delay between moving back and forth and per pixel
int refresh=300;
int PixelCount=22; //Set this to the AMOUNT of Led's/Pixels you have or want to use on your strip And It can be used to tell where to Stop then return the eye at in the strip
...
void loop() {
  ...
  CylonEyeUp(strip.Color(21,21,141), strip.Color(21,21,141), strip.Color(21,21,141                                                                                                                                                                                                                                                                                                                                                                                 ), wait_T, PixelCount, Pixel_Start_End);
  delay(wait_T);
